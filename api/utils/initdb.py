...
def initialize_data():
        ...
        page11 = Page(image=image11_url ,description='blue 1', creator_id='1', book_id=book1._id, created_at=now(), interval_id=1, status='winner')
        page11.save()
        page12 = Page(image=image12_url ,description='blue 2', creator_id='2', book_id=book1._id, created_at=now(), interval_id=2, status='winner')
        page12.save()
        page13 = Page(image=image13_url ,description='blue 3', creator_id='3', book_id=book1._id, created_at=now(), interval_id=3)
        page13.save()
        page21 = Page(image=image21_url ,description='black 1', creator_id='1', book_id=book2._id, created_at=now(), interval_id=9, status='winner')
        page21.save()
        page22 = Page(image=image22_url ,description='black 2', creator_id='2', book_id=book2._id, created_at=now(), interval_id=10)
        page22.save()
